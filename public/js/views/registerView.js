define(['jquery', 'backbone', 'templates/register', 'templates/confirmation', 'user', 'validation', 
    'validators/register', 'errorMessages/register'],
